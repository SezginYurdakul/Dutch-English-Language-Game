// import { wordList } from "./js/wordList.js"; // Import the word list
...
//   const distractors = [];
//   const allAnswers = wordList.map((word) =>
//     gameMode === "dutch-to-english" ? word.english : word.dutch
//   );
...
// const questionCountButtons = document.querySelectorAll(
...
//   if (
//     currentWordIndex >= questionCount ||
//     currentWordIndex >= shuffledWordList.length
//   ) {
...
//     currentWordIndex + 1
//   } / ${questionCount}`; // Update progress text
...
//   speakWord(
//     selectedOption,
//     gameMode === "dutch-to-english" ? "en-US" : "nl-NL"
//   );
...
//       .forEach((b) => b.classList.remove("difficulty-selected"));
...
//   quizContainerEl.innerHTML = `
//         <h2 id="quiz-title"></h2>
//         <div id="dutch-word"></div>
//         <div id="options-container"></div>
//         <div id="feedback"></div>
//         <div id="stats-container">
//             <span>Correct: <span id="correct-score">0</span></span>
//             <span>Wrong: <span id="wrong-score">0</span></span>
